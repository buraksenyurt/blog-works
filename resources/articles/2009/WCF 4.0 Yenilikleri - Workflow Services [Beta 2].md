...
![blg78_Giris.jpg](images/blg78_Giris.jpg)
...
Kişisel Not: Windows XP, Vista ve 7 sürümlerinde kullandığım Visual Studio 2010 Beta 1 ürününde, WF Designer sürekli olarak hata verip IDE'yi Restart işlemine zorlamaktaydı.![Undecided](images/smiley-undecided.gif) Neyseki bu sorun Visual Studio 2010 Beta 2 sürümünde ortadan kaldırılmış durumdadır.![Wink](images/smiley-wink.gif)
...
![blg78_NewProject.gif](images/blg78_NewProject.gif)
...
![blg78_FirstScreen.gif](images/blg78_FirstScreen.gif)
...
![blg78_Variables.gif](images/blg78_Variables.gif)
...
![blg78_NewService.gif](images/blg78_NewService.gif)

MathService.xamlx servisinin tasarım görüntüsü aşağıdaki gibidir.

![blg78_MathServiceDsgn.gif](images/blg78_MathServiceDsgn.gif)
...
![blg78_Runtime.gif](images/blg78_Runtime.gif)
...
![blg78_Xsd1.gif](images/blg78_Xsd1.gif)
...
![blg78_ClientRuntime.gif](images/blg78_ClientRuntime.gif)
...
![blg78_ClientXml.gif](images/blg78_ClientXml.gif)
...
[AdventureWFServices.rar (442,66 kb)](assets/AdventureWFServices.rar)
