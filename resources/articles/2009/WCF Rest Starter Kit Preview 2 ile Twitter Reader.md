...
![blg56_giris.gif](images/blg56_giris.gif)

Merhaba Arkadaşlar,

Minik bir çocukken Televizyon bağımlılığı (Malesef bu aptal kutuda çok vakiy geçirebiliyor çocuklar ![Frown](images/smiley-frown.gif)) nedeniyle pek çok çizgi filmi izlediğimi hatırlıyorum. Voltran, Transformers, Red Kit ve Daltonlar, Denver The Last Dinasour, Clementine filan derken arada sıradada "Bi kedi gördüm sanki" diyen Tweety

![Laughing](images/smiley-laughing.gif)

Şimdi bu konuya nereden geldiğimi düşünebilirsiniz. Şu sıralarda sık sık takip ettiğim geekswithblogs sitesinde twitter'da (Sanırım niye cikcik diyerek yazımıza başladığımızı anlamışsınızdır ![Laughing](images/smiley-laughing.gif)) yayınlanan içeriklerin WCF Rest Starter Kit Preview 2 ile birlikte gelen HttpClient sınıfı yardımıyla nasıl kolayca ele alınabileceğine dair bazı yazılar gördüm.
...
Örneğin, XML içeriğini managed tarafta kolayca ele alabilmemiz için gerekli tiplerin üretimini kolaylaştıran Paste XML As Types ![Laughing](images/smiley-laughing.gif) Örneği geliştirebilmek için çok sık kullanmasamda Twitter'da bir hesap oluşturdum ve bildiğim geliştiricilerin Tweet'lerini takip etmeye başladım. İşe başlamadan önce, Twitter'da ne olup bittiğine bir bakayım dedim.

![blg56_Twitter.gif](images/blg56_Twitter.gif)
...
![blg56_WindowsReferences.gif](images/blg56_WindowsReferences.gif)
...
![blg56_TwitterTimelineXML.gif](images/blg56_TwitterTimelineXML.gif)
...
![blg56_ClassDiagram.gif](images/blg56_ClassDiagram.gif)
...
![blg56_Form.gif](images/blg56_Form.gif)
...
![blg56_GetFeeds.gif](images/blg56_GetFeeds.gif)
...
![blg56_PostNewFeed.gif](images/blg56_PostNewFeed.gif)
...
![blg56_NewTweetLast.gif](images/blg56_NewTweetLast.gif)
...
![blg56_PostNewFeedWin.gif](images/blg56_PostNewFeedWin.gif)
...
[TwitterReader.rar (187,66 kb)](assets/TwitterReader.rar)
