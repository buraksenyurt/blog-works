...
# .Net Framework 4.0 System.IO.File Tarafındaki Yenilikler
![blg199_Giris_.jpg](images/blg199_Giris_.jpg)
...
Tabi bu tip dosyaların en büyük özelliği de veri taşımak amacıyla satır ve sütun kavramlarını kullanmalarıdır. Ayrıca verinin çok yalın bir formatta taşınması ve her tür platform tarafından kolayca ele alınması, hatta çıplak gözle (Tabi zaman zaman. Nitekim benim üzerinde çalıştığım SSIS paketlerinin sütunlarının sayısı 250’ ye varmaktaydı ![Sealed](images/smiley-sealed.gif)) rahatlıkla okunabilmesi gibi avantajlar da söz konusudur. Buna göre aşağıdaki gibi bir text içeriği doğru bir veri saklama biçimi olarak düşünülebilir.

![blg199_TextContent_.gif](images/blg199_TextContent_.gif)
...
![blg199_ReadAllLines_.gif](images/blg199_ReadAllLines_.gif)
...
![blg199_ReadLinesRuntime_.gif](images/blg199_ReadLinesRuntime_.gif)
...
![blg199_WriteAllLinesOld_.gif](images/blg199_WriteAllLinesOld_.gif)
...
![blg199_WriteAllLinesNew_.gif](images/blg199_WriteAllLinesNew_.gif)
...
[NewIOFeatures.rar (21,53 kb)](assets/NewIOFeatures.rar) [Örnek Visual Studio 2010 Ultimate sürümünde geliştirilmiş ve test edilmiştir]
