...
Gelin önce problemli bir tasarım ile yola çıkalım ve sonrasında ise OCP'i nasıl uygulayabileceğimize bakalım (ki bu noktada bir önceki blog yazısına göre bir dejavu yaşayabilirsiniz benden söylemesi ![Surprised](images/smiley-surprised.gif))

![blg36_1.gif](images/blg36_1.gif)
...
![blg36_2.gif](images/blg36_2.gif)

Bu kez ImageBase isimli bir ata sınıfı işin içerisine katmışız gibi görünüyor. Hatta koduda aşağıda şekilde tasarladığımızı düşünelim (Tabi bu şekilde kod yazmamızın amacı tamam şakacıktan. Amaç bizi Open Close prensibine götüren sebepleri ortaya koyabilmek. ![Wink](images/smiley-wink.gif))

![blg36_4.gif](images/blg36_4.gif)
...
![blg36_3.gif](images/blg36_3.gif)
...
![blg36_5.gif](images/blg36_5.gif)
...
[OCP.rar (42,53 kb)](assets/OCP.rar)
