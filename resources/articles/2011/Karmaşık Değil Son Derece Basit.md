...
[![experience](images/experience_thumb.jpg)](images/experience.jpg) Merhaba Arkadaşlar,
...
![Göz kırpan gülümseme](images/wlEmoticon-winkingsmile_66.png)
...
[![bei_3](images/bei_3_thumb.gif)](images/bei_3.gif)
...
[![bei_4](images/bei_4_thumb.gif)](images/bei_4.gif)
...
[![bei_5](images/bei_5_thumb.gif)](images/bei_5.gif)
...
![Gülümseme](images/wlEmoticon-smile_15.png)
...
Metodun içeriği son derece basittir. Exception yönetimi metodu kullanan bir üst katmana bırakılmıştır (catch bloğu içerisinde yaptığımız throw hareketine dikkat edin![Göz kırpan gülümseme](images/wlEmoticon-winkingsmile_66.png)) Diğer yandan BinaryFormatter tipinden yararlanılmış ve metoda parametre olarak gelen FilePath ile işaret edilen ve FileStream ile yazmak üzere açılan dosyaya doğru bir serileştirme işlemi gerçekleştirilmektedir.
...
[![bei_6](images/bei_6_thumb.gif)](images/bei_6.gif)
...
[![bei_7](images/bei_7_thumb.gif)](images/bei_7.gif)
...
[![bei_8](images/bei_8_thumb.gif)](images/bei_8.gif)

Generate Dependency Graph’ ı seviyorummm

![Açık ağızlı gülümseme](images/wlEmoticon-openmouthedsmile_15.png)
...
[GercekHayatOrnekleri.rar (58,66 kb)](assets/GercekHayatOrnekleri.rar)
