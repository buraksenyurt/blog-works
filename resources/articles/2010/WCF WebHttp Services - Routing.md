...
![blg138_Giris.jpg](images/blg138_Giris.jpg)
...
![blg138_Solution.gif](images/blg138_Solution.gif)
...
![blg138_ClassDiagram.gif](images/blg138_ClassDiagram.gif)
...
![blg138_Case.gif](images/blg138_Case.gif)

Hemen çalışma zamanı sonuçlarına bir bakalım. Örneğin http://localhost:10860/Productions/Products/1029 talebinde bulunduğumuzda aşağıdaki sonuçlar ile karşılaşırız. Görüldüğü üzere talep ProductionService'e yönlendirilmiştir. (Tabi var olmayan bir ProductID talebi girildiğinde HTTP Status Code 404 NotFound ile karşılaşırız. WebFaultException tipinin kullanımının anlatıldığı yazımızı hatırlayalım lütfen ![Wink](images/smiley-wink.gif))

![blg138_Runtime1.gif](images/blg138_Runtime1.gif)
...
![blg138_Runtime2.gif](images/blg138_Runtime2.gif)
...
[Lesson5_RC.rar (24,11 kb)](assets/Lesson5_RC.rar) [Örnek Visual Studio 2010 Ultimate Beta 2 Sürümünde geliştirilmiş ancak RC sürümü üzerinde de test edilmiştir]
