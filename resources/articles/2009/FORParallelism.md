...
# FORParallelism
![blg100_Giris.jpg](images/blg100_Giris.jpg)
...
Peki elimizde bu kütüphane olmasaydı? ![Sealed](images/smiley-sealed.gif) O zaman n sayıda tekrar edecek olan bir işlemi paralel hale getirmek için nasıl bir kodlama yapmamız gerekirdi?
...
![blg100_FirstRun.gif](images/blg100_FirstRun.gif)

İlk çalışma sonucu elde edilen Concurrency Profiler çıktısı;

![blg100_FirstReport.gif](images/blg100_FirstReport.gif)
...
![blg100_SecondRun.gif](images/blg100_SecondRun.gif)

İkinci modele göre Concurrency Profiler çıktısı;

![blg100_SecondReport.gif](images/blg100_SecondReport.gif)
...
![blg100_ThirdRun.gif](images/blg100_ThirdRun.gif)

Parallel.For kullanımına göre Concurrency Profiler çıktısı;

![blg100_ThirdReportAgain.gif](images/blg100_ThirdReportAgain.gif)
...
[TaskParallelLibrary.rar (89,38 kb)](assets/TaskParallelLibrary.rar)
