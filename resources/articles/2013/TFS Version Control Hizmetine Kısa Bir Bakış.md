...
[![versioncontrolfunny](images/versioncontrolfunny_thumb.png)](images/versioncontrolfunny.png)
...
[![tfsvc_1](images/tfsvc_1_thumb.png)](images/tfsvc_1.png)

Uygulamamıza ait Form ise aşağıdaki gibi tasarlanabilir.

[![tfsvc_2](images/tfsvc_2_thumb.png)](images/tfsvc_2.png)
...
> [![tfsvc_5](images/tfsvc_5_thumb.png)](images/tfsvc_5.png)
...
[![tfsvc_3](images/tfsvc_3_thumb.png)](images/tfsvc_3.png)
...
[![tfsvc_4](images/tfsvc_4_thumb.png)](images/tfsvc_4.png)

Dikkat edileceği üzere Default Collection altındaki bir Team Project’ in içerisinde yer alan C# kod dosyalarının temel bilgileri çekilebilmiştir. Bu bilgiler arasında, Item ve Change Set numarası ile Server üzerinde tutulan Full Path bilgisi yer almaktadır. Hatta istenirse son Check-In bilgisi bile alınabilir (Belki de alınamaz. Neden araştırmıyorsunuz ![Winking smile](images/wlEmoticon-winkingsmile_197.png)) İşin güzel yanı söz konusu öğelerden herhangibirisine tıklandığında, içeriğinin de görüldüğüdür.
...
[HowTo_VersionControl.zip (218,31 kb)](assets/HowTo_VersionControl.zip)
